...
```
usage: Most Used Words [-h] [-f FILE] [-i INPUT] [-o OUTPUT] [-of {json,xml}] [-n NUMBER] [-s START] [-sw {english,french}] [-v]
...
optional arguments:
  ...
  -sw {english,french}, --stopwords {english,french}
                        If specified will remove stopwords (such as 'a' 'the' 'wich' etc.) (defined by languages in config.conf)
  -v, --verbose
